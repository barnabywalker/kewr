...
vignette: >
  %\VignetteIndexEntry{building-checklist}
...
Now we have all the records for our species, we can format them as a data frame to make subsequent analysis a bit easier.

```{r}
iceland_checklist <- map_dfr(iceland_records, format)
iceland_checklist
```
...
iceland_endemics <- map_dfr(iceland_records, format)
